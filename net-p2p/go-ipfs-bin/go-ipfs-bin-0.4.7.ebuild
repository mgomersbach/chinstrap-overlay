...
SRC_URI="amd64? ( https://dist.ipfs.io/go-ipfs/v${MY_PV}/go-ipfs_v${MY_PV}_linux-amd64.tar.gz )
	x86? ( https://dist.ipfs.io/go-ipfs/v${MY_PV}/go-ipfs_v${MY_PV}_linux-386.tar.gz )"

...
# Pin source/target compat to 21 — gradle 8.5 cannot run under JDK 25 cleanly,
# and ghidra requires JDK 21 anyway (Ghidra/application.properties).
...
src_prepare() {
	...
	# Strip the date suffix so build/dist/ paths are predictable for src_install.

...
SRC_URI="http://downloads.sourceforge.net/project/snort/OLD%20STUFF%20THAT%20YOU%20SHOULDNT%20USE/${P}.tar.gz"
LICENSE="GPL-2"
SLOT="0"
...
+normalizer reload-error-restart +react +flexresp3 +paf large-pcap-64bit snortsam
...
src_prepare() {
	...
	if ! use snortsam ; then
	    epatch "${FILESDIR}/snortsam-2.9.5.3-1.diff"
	fi

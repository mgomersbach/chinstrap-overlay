...
SLOT="0"
IUSE="X aqua debug directfb doc drm gallium gles2 +glib legacy-drivers lto opengl openvg qt4 static-libs +svg valgrind xcb xlib-xcb"
...
src_configure() {
	...
	use lto && append-flags -ffat-lto-objects
